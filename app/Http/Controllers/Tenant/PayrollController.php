...
class PayrollController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'period_type' => ['nullable', 'string', 'in:weekly,semi-monthly'],
        ]);

        $validated['period_start'] = $validated['start_date'];
        $validated['period_end'] = $validated['end_date'];
        $validated['period_type'] = $validated['period_type'] ?? 'weekly';
