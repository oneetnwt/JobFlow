<x-layouts.landing>
    ...
    <section class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="inline-flex items-center px-3 py-1 rounded-full bg-slate-100 text-[#2D7DD2] text-[10px] font-bold uppercase tracking-widest mb-8 border border-slate-200">
                <span class="relative flex h-2 w-2 mr-2">
                    <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#2D7DD2] opacity-75"></span>
            ...
            <div class="relative max-w-5xl mx-auto">
                <div class="rounded-xl border border-slate-200 bg-white shadow-2xl overflow-hidden aspect-[16/10] sm:aspect-[16/8] flex">
                    <!-- Sidebar Mockup -->
                ...
                <!-- Floaties -->
                <div class="absolute -top-6 -right-6 h-32 w-48 bg-white border border-slate-200 rounded-lg shadow-xl hidden lg:block p-4">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div>
                    ...
                    <div class="text-xs font-bold text-slate-500 uppercase tracking-widest mt-1 text-center">Uptime SLA</div>
                </div>
                <div>
                    <div class="text-3xl font-extrabold text-white tracking-tight">500ms</div>
                    <div class="text-xs font-bold text-slate-500 uppercase tracking-widest mt-1 text-center">Latency</div>
                </div>
                <div>
                    <div class="text-3xl font-extrabold text-white tracking-tight">10k+</div>
                    <div class="text-xs font-bold text-slate-500 uppercase tracking-widest mt-1 text-center">Jobs Tracked</div>
                </div>
                <div>
                    <div class="text-3xl font-extrabold text-white tracking-tight">256-bit</div>
                    <div class="text-xs font-bold text-slate-500 uppercase tracking-widest mt-1 text-center">Encryption</div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 border-t border-l border-slate-100">
                ...
                <div class="p-10 border-r border-b border-slate-100 hover:bg-slate-50/50 transition-colors">
                    <div class="h-10 w-10 bg-[#2D7DD2]/10 rounded-lg flex items-center justify-center text-[#2D7DD2] mb-6">
                    ...
                    <p class="text-sm text-slate-500 leading-relaxed">
                        Full lifecycle management from draft to completion. Track sub-tasks, progress bars, and high-priority deadlines.
                    </p>
                </div>
                <!-- Feature 2 -->
                <div class="p-10 border-r border-b border-slate-100 hover:bg-slate-50/50 transition-colors">
                    ...
                    <p class="text-sm text-slate-500 leading-relaxed">
                        Detailed worker profiles with skill tracking, department grouping, and individual performance analytics.
                    </p>
                </div>
                <!-- Feature 3 -->
                <div class="p-10 border-r border-b border-slate-100 hover:bg-slate-50/50 transition-colors">
                    ...
                    <p class="text-sm text-slate-500 leading-relaxed">
                        Automatic compensation engine. Compute pay based on rendered tasks or hours with seamless period releases.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-24 bg-slate-50 border-y border-slate-100">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-slate-500 mb-10">
                Join the operations teams that have moved from spreadsheets to JobFlow OMS. Start your 14-day isolated workspace trial.
            </p>
            <div class="flex justify-center">
                <a href="{{ route('tenant.register.create') }}" class="px-10 py-5 bg-[#2D7DD2] text-white rounded-lg font-bold text-xl hover:bg-[#1E3A5F] transition-all shadow-xl shadow-blue-100">
